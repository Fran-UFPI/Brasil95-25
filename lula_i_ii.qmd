...
ggplot(dados_lula1, aes(x= data_final, y= ipca_trimestral)) +
  ...
  labs(
 title = "A Dinâmica do IPCA no Governo Lula I",
...
names(dados_euro)[2] <- "value"
 ...
 ggplot(dados_graflula1,aes(x=Data,y=Taxa,color=Moeda))+
  ...
  labs(
    title = "A Dinâmica Cambial no Governo Lula I",
    subtitle = "Taxa de Câmbio em Relação ao Dólar, Euro e Yuan (2003–2006)",
    x= "Ano",
    y= "preçoem Real(R$)",
    fill="Regime Cambial",
...
ggplot(dados_selic_lula1, aes(x= Anos, y = Selic))+
  ...
  scale_y_continuous(labels = function(x)paste0(x,"%"))+
  labs(
    title = "A Dinâmica da Taxa Selic no Governo Lula I",
...
ggplot(dados_lula2, aes(x= data_final, y= ipca_trimestral)) +
  ...
  scale_y_continuous(labels = function(x)paste0(x,"%"))+
  labs(
    title = "A Dinâmica do IPCA no Governo Lula II",
    subtitle = "Variação Trimestral da Inflação Oficial (Série Encadeada — Base: Dezembro de 1993)",
    x = "Ano",
...
names(dados_euro)[2] <- "value"
 ...
 ggplot(dados_graflula2,aes(x=Data,y=Taxa,color=Moeda))+
  ...
  labs(
    title = "A Dinâmica Cambial no Governo Lula II",
    subtitle = " Taxa de Câmbio em Relação ao Dólar, Euro e Yuan (2007–2010)",
    x= "Ano",
    y= "preço em Real(R$)",
    fill="Regime Cambial",
    color= "Regime Cambial",
...
ggplot(dados_selic_lula2, aes(x= Anos, y = Selic))+
  ...
  scale_y_continuous(labels = function(x)paste0(x,"%"))+
  labs(
    title = "A Dinâmica da Taxa Selic no Governo Lula II (2007–2010)",
