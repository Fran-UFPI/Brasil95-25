...
INSTITUTO BRASILEIRO DE GEOGRAFIA E ESTATÍSTICA (IBGE). **Sistema IBGE de Recuperação Automática (SIDRA)**. Disponível em: [https://sidra.ibge.gov.br/](https://www.google.com/search?q=https://sidra.ibge.gov.br/).

### Livros utilizados:

![](imagens/livro1.png){fig-align="center" width="30%"}
...
![](imagens/livro2.png){fig-align="center" width="30%"}
